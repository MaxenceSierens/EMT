//De Meriem " Programme Complet"
// variables et zones de données eclatées

/************************************/
/***    Arduino Wattmeter v1.0    ***/
/***    Board: Arduino Nano 3.0   ***/
/***  By: Freddy repris par Meriem et JPS   ***/
...
char* paramLabels[] = {"Vmean ","Imean ","Preal ","Energy","time  "};
//char* paramUnits[] = {"V","V","V","V","V","Vs","A","A","A","A","A","C","Hz","W","VA","var","W","W","J","\x02","s"};
...
char* paramUnits[] = 
{"V",//1_Vmean : tension moyenne 


"A",//7_Imean : courant moyen


"W",//13_Preal : puissance réelle
"J",//18_énergie en Joule

"s"}; //20_temps en Secondes
...
void setup() {
  ...
  lcdWrite(true, LCDlinePos[0]);       // LCD cursor first line position 0
  lcdPrintString("Meriem_EMT_2016");
  lcdWrite(true, LCDlinePos[1]);       // LCD cursor second line position 0
  lcdPrintString("           .info");
  for(int md=0; md<100; md++) {        // Wait 2 seconds
    muDelay(20000);
